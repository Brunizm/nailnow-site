...
function pickFirstStringValue(values, fallback = "") {
...
function resolveSendgridSettings(overrides = {}) {
  ...
  return {
    apiKey: pickFirstStringValue(apiKeyCandidates),
    sender: pickFirstStringValue(senderCandidates, SUPPORT_SENDER),
    templateClient: pickFirstStringValue(templateClientCandidates),
    templateProfessional: pickFirstStringValue(templateProfessionalCandidates),
    templateProfessionalSignup: pickFirstStringValue(templateProfessionalSignupCandidates),
  };
}
...
function ensureSendgridClient(apiKey) {
  ...
  if (configuredSendgridKey === trimmedKey) {
    return true;
  }

  try {
    sgMail.setApiKey(trimmedKey);
    configuredSendgridKey = trimmedKey;
    return true;
  } catch (error) {
